...
fishdat = read.csv("/Users/Anna/Documents/ResearchGit/DStagging/rawData/Expt1_DStagloc_All.csv")
...
morts = read.csv("/Users/Anna/Documents/ResearchGit/DStagging/rawData/Expt1_DStagloc_NecropsyNotes_asof20231207.csv")
 # add leading 0 back into TagID_Hex
...
tagdat2 = merge(tagdat, morts[,c("TagID_Hex","MortDate","ReasonforMort",
...
tagdat2$RecovTime = as.numeric( difftime( as.POSIXct(paste(tagdat2$DateTagged, tagdat2$Time_recovered), format="%m/%d/%y %H:%M:%S", tz="America/Los_Angeles"), as.POSIXct(paste(tagdat2$DateTagged, tagdat2$Time_out_surgery), format="%m/%d/%y %H:%M:%S", tz="America/Los_Angeles") ) )
```
